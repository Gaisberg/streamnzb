...
const FORMAT_FIELDS = [
  ...
  { group: 'Parsed', fields: ['.ParsedTitle', '.Year', '.Date', '.Resolution', '.Quality', '.Codec', '.BitDepth', '.Bitrate', '.Container', '.Extension', '.Group', '.Edition', '.Network', '.Site', '.Country', '.Region', '.Audio', '.Channels', '.HDR', '.Extras', '.ParsedSize', '.Languages', '.LanguageFlags', '.Subtitles', '.LanguageSource', '.ParsedLanguages', '.ParsedSubtitles'] },
  { group: 'Episode', fields: ['.Season', '.Episode', '.Seasons', '.Episodes', '.EpisodeCode', '.Volumes'] },
  { group: 'Flags', fields: ['.Proper', '.Repack', '.Remastered', '.Upscaled', '.ThreeD', '.Scene', '.Retail', '.Hardcoded', '.Dubbed', '.Subbed', '.DualAudio', '.Commentary', '.Complete', '.Documentary', '.Unrated', '.Uncensored', '.PPV', '.Adult', '.Convert', '.Trash', '.Torrent'] },
  ...
  { group: 'Lists', fields: ['sortAsc .Audio', 'sortDesc .Channels', 'first .Audio', 'last .Audio', 'length .HDR', 'join (sortAsc .Audio) " · "', 'join (flags .Subtitles) " "', 'join (union .Languages .Subtitles) " · "', 'join (without .Languages .Subtitles) " · "', 'join (without .ParsedSubtitles .ParsedLanguages) " · "'] },
