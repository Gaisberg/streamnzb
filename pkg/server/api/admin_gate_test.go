...
func TestAdminOnlyRoutesRejectADeviceToken(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"nzb attempts clear", http.MethodDelete, "/api/nzb-attempts/clear",
			func(s *Server) http.HandlerFunc { return s.handleClearNZBAttempts }},
		...
		{"library clear", http.MethodDelete, "/api/library/clear",
