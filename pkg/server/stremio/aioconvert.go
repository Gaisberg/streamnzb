...
var aioFieldMap = map[string]aioField{
	...
	"stream.languageemojis": {expr: ".LanguageFlags", kind: kindStrList,
		note: "{stream.languageEmojis} mapped to {{.LanguageFlags}}, which omits the languages no single flag identifies (Turkish, Persian, the Indian languages other than Hindi)"},
	"stream.ulanguageemojis": {expr: ".LanguageFlags", kind: kindStrList,
		note: "{stream.uLanguageEmojis} mapped to {{.LanguageFlags}}, which omits the languages no single flag identifies (Turkish, Persian, the Indian languages other than Hindi)"},
	"stream.dubbed":     {expr: ".Dubbed", kind: kindBool},
	"stream.subbed":     {expr: ".Subbed", kind: kindBool},
	"stream.subtitles":  {expr: ".Subtitles", kind: kindStrList},
	"stream.usubtitles": {expr: ".Subtitles", kind: kindStrList, note: "user-configured subtitle lists mapped to {{.Subtitles}}"},
	"stream.subtitleemojis": {expr: "(flags .Subtitles)", kind: kindStrList,
		note: "{stream.subtitleEmojis} mapped to (flags .Subtitles), which omits the languages no single flag identifies (Turkish, Persian, the Indian languages other than Hindi)"},
	"stream.usubtitleemojis": {expr: "(flags .Subtitles)", kind: kindStrList,
		note: "{stream.uSubtitleEmojis} mapped to (flags .Subtitles), which omits the languages no single flag identifies (Turkish, Persian, the Indian languages other than Hindi)"},
